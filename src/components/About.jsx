    ...
    <section id='about' className='section'>
        <div className='container'>
            <div className='bg-zinc-800/50 p-7 rounded-2xl md:p-12 reveal-up'>
                ...
                md:max-w-[60ch]'>
                Welcome! I&apos;m Widnew Birhanu, a professional web developer with a knack for crafting
                ...
                <div className='flex flex-wrap items-center gap-4 md:gap-7'>
                    ...
                    <img src={logo} width={30} height={30} className='ml-auto
                    md:w-[40px] md:h-[40px]' alt="logo"/>
                </div>
            </div>
        </div>
    </section>
